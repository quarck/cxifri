 ...
 *
 * <p>{@code WIFI:T:[network type];S:[network SSID];P:[network passwordText];H:[hidden?];;}</p>
 *
 * <p>For WPA2 enterprise (EAP), strings will be of the form:</p>
 *
 * <p>{@code WIFI:T:WPA2-EAP;S:[network SSID];H:[hidden?];E:[EAP method];H:[Phase 2 method];A:[anonymous identity];I:[username];P:[passwordText];;}</p>
 *
